<x-layout>
    <h3 class="page-title">Transaction Details for Device ID {{ $deviceId }} with Transaction Status ({{ ucfirst($transactionStatus) }})</h3>
                ...
                <div class="row mt-1 align-items-center">
                    <div class="col-12 text-left pl-4">
                        <div class="card-body">
                            ...
                            <a href="{{ route('transactions.bydevice') }}" class="btn btn-dark mt-3">Back</a>
                        </div>
                    </div>
                </div>
            </div>
